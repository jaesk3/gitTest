...
//    }
//  );
//  ics::ArrayQueue<op_entry> pts1_answer(
//    {
//       op_entry(3,Point(3,-3)),
//       op_entry(5,Point(-2,-2)),
//       op_entry(6,Point(-2,1)),
...
//    std::random_shuffle(pts1_vec.begin(), pts1_vec.end());
//    ics::ArrayMap<ordinal, Point> pts1(pts1_vec);
//    ASSERT_EQ(pts1_answer, sort_yo(pts1));
//  }
//
//
//  std::vector<op_entry> pts2_vec(
//    {
...
//    }
//  );
//  ics::ArrayQueue<op_entry> pts2_answer(
//    {
//      op_entry(8,Point(2,-5)),
//      op_entry(6,Point(4,-2)),
//      op_entry(5,Point(-2,-2)),
...
//  );
//  for (int i = 0; i < times_to_test; ++i ) {
//    std::random_shuffle(pts2_vec.begin(), pts2_vec.end());
//    ics::ArrayMap<ordinal, Point> pts2(pts2_vec);
//    ASSERT_EQ(pts2_answer, sort_yo(pts2));
//  }
//}
//
//
...
//      }
//  );
//  ics::ArrayQueue<Point> pts1_answer(
//    {
//       Point(-3,4),
//       Point(3,-3),
//       Point(3,2),
...
//    std::random_shuffle(pts1_vec.begin(), pts1_vec.end());
//    ics::ArrayMap<ordinal, Point> pts1(pts1_vec);
//    ASSERT_EQ(pts1_answer, sort_distance(pts1));
//  }
//
//  std::vector<op_entry> pts2_vec(
//    {
...
//    }
//  );
//  ics::ArrayQueue<Point> pts2_answer(
//    {
//      Point(5,3),
//      Point(2,-5),
//      Point(-5,1),
...
//    std::random_shuffle(pts2_vec.begin(), pts2_vec.end());
//    ics::ArrayMap<ordinal, Point> pts2(pts2_vec);
//    ASSERT_EQ(pts2_answer, sort_distance(pts2));
//  }
//}
//
//
...
//    std::random_shuffle(pts1_vec.begin(), pts1_vec.end());
//    ics::ArrayMap<ordinal, Point> pts1(pts1_vec);
//    ASSERT_EQ(pts1_answer, points(pts1));
//  }
//
//  std::vector<op_entry> pts2_vec(
//    {
...
//    std::random_shuffle(pts2_vec.begin(), pts2_vec.end());
//    ics::ArrayMap<ordinal, Point> pts2(pts2_vec);
//    ASSERT_EQ(pts2_answer, points(pts2));
//  }
//}
//
//
...
//    }
//  );
//  ics::ArrayQueue<ans_entry> pts1_answer(
//    {
...
//    std::random_shuffle(pts1_vec.begin(), pts1_vec.end());
//    ics::ArrayMap<ordinal, Point> pts1(pts1_vec);
//    ASSERT_EQ(pts1_answer, angles(pts1));
//  }
//
//  std::vector<op_entry> pts2_vec(
//    {
...
//    }
//  );
//  ics::ArrayQueue<ans_entry> pts2_answer(
//    {
//        ans_entry(5,atan2(-2,-2)),
...
//    std::random_shuffle(pts2_vec.begin(), pts2_vec.end());
//    ics::ArrayMap<ordinal, Point> pts2(pts2_vec);
//    ASSERT_EQ(pts2_answer, angles(pts2));
//  }
//}
//
//
